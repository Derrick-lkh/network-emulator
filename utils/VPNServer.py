...
class VPNServer:
    ...
    def encrypt(self, client_ip, data, pub_src_ip, src_ip, dest_ip, pub_dest_ip="", protocol="0") -> Packet:
        """
        ...
        vpn_packet = Packet(encoded_payload, pub_src_ip, pub_dest_ip, protocol=PROTOCOL_TYPE.get("VPN"))
        return vpn_packet
